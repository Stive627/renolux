...
const LinkPhone = () => (<div className=' flex flex-row gap-3 border rounded-md px-3 py-2'><span><LocalPhoneIcon className=' text-slate-700' /></span><p className=' text-slate-700'>Nous Joindre par telephone</p></div>)
